...
class CreateTPermohonanTinjauan extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('t_permohonan_tinjauan', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('t_permohonan_tinjauan');
    }
}

        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary"> 
                <form action="{{ route('perencanaan.update', ['perencanaan' => $data['id']])  }}" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                               <select name="id_perusahaan_" id="id_perusahaan_" onchange="permohonanNoProses()" disabled class="form-control select2">
                                <option value="">{{ $klien['jenis_badan_usaha'].' '.$klien['nama_perusahaan'] }}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                               <input type="text" name="no_proses" class="form-control" value="{{ $data['no_proses'] }}" readonly>
                            </div>
                            ...
                            <table id="tablePermohonan" class="table stripted-table">
                                ...
                                @foreach ($permohonan as $item)
                                    <tr>
                                        <td><input type="checkbox" name="pilihNoProses[]" checked class="form-control" value="{{ $item->id }}"></td>
                                        <td>{{ $item->no_proses }}</td>
                                        <td>{{ $item->no_order }}</td>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                               <input type="number" name="jml_auditor_kepala" class="form-control" value="{{ $data['jml_auditor_kepala'] }}">
                            </div>
                            <label for="file" class="col-sm-2 col-form-label">Hari Kerja Auditor Kepala</label>
                            <div class="col-sm-4">
                               <input type="number" name="hari_kerja_auditor_kepala" class="form-control" value="{{ $data['hari_kerja_auditor_kepala'] }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                               <input type="number" name="jumlah_perdiem_auditor_kepala" class="form-control" value="{{ $data['jumlah_perdiem_auditor_kepala'] }}">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                               <input type="number" name="jumlah_auditor" class="form-control" value="{{ $data['jumlah_auditor'] }}">
                            </div>
                            <label for="file" class="col-sm-2 col-form-label">Hari Kerja Auditor</label>
                            <div class="col-sm-4">
                               <input type="number" name="hari_kerja_auditor" class="form-control" value="{{ $data['hari_kerja_auditor'] }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                               <input type="number" name="hari_perdiem_auditor" class="form-control" value="{{ $data['hari_perdiem_auditor'] }}">
                            </div>

                            <label for="file" class="col-sm-2 col-form-label">Jumlah Mandays Auditor</label>
                            <div class="col-sm-4">
                               <input type="number" name="jumlah_mandays_auditor" class="form-control" value="{{ $data['jumlah_mandays_auditor'] }}">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                               <input type="number" name="jumlah_tenaga_ahli" class="form-control" value="{{ $data['jumlah_tenaga_ahli'] }}">
                            </div>

                            <label for="file" class="col-sm-2 col-form-label">Jumlah Mandays Tenaga Ahli</label>
                            <div class="col-sm-4">
                               <input type="number" name="jumlah_mandays_tenaga_ahli" class="form-control" value="{{ $data['jumlah_mandays_tenaga_ahli'] }}">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                               <input type="number" name="jumlah_observer" class="form-control" value="{{ $data['jumlah_observer'] }}">
                            </div>

                            <label for="file" class="col-sm-2 col-form-label">Jumlah Mandays Observer</label>
                            <div class="col-sm-4">
                               <input type="number" name="jumlah_mandays_observer" class="form-control" value="{{ $data['jumlah_mandays_observer'] }}">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                               <input type="number" name="jumlah_ppc" class="form-control" value="{{ $data['jumlah_ppc'] }}">
                            </div>

                            <label for="file" class="col-sm-2 col-form-label">Jumlah Mandays PPC</label>
                            <div class="col-sm-4">
                               <input type="number" name="jumlah_mandays_ppc" class="form-control" value="{{ $data['jumlah_mandays_ppc'] }}">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                               <input type="number" name="jumlah_perdiem" class="form-control" value="{{ $data['jumlah_perdiem'] }}">
                            </div>

                            <label for="file" class="col-sm-2 col-form-label">Jumlah per Diem per personel</label>
                            <div class="col-sm-4">
                               <input type="number" name="jumlah_perdiem_personel" class="form-control" value="{{ $data['jumlah_perdiem_personel'] }}">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                               <input type="number" name="jumlah_sni" class="form-control" value="{{ $data['jumlah_sni'] }}">
                            </div>

                            <label for="file" class="col-sm-2 col-form-label">Jumlah Sertifikat</label>
                            <div class="col-sm-4">
                               <input type="number" name="jumlah_sertifikat" class="form-control" value="{{ $data['jumlah_sertifikat'] }}">
                            </div>
                        ...
                        <table class="table stripted-table">
                            <tr>
                                ...
                                <th style="width: 3%">:</th>
                                <th id="asalProduk">
                                    {{ $klien['provinsi_pabrik'] }}
                                </th>
                            </tr>
                            <tr>
                                <th>Jumlah Tahapan Proses</th>
                                <th>:</th>
                                <th id="jumlahTahapanProses">
                                    {{ $klien['jumlah_tahapan_proses'] }}
                                </th>
                            </tr>
                            <tr>
                                <th>Jumlah Line Produksi</th>
                                <th>:</th>
                                <th id="jumlahLineProduksi">
                                    {{ $klien['line_produksi'] }}
                                </th>
                            </tr>
                            <tr>
                                ...
                                <th>:</th>
                                <th id="jumlahShiftPerHari">
                                    {{ $klien['jumlah_shift_per_hari'] }}
                                </th>
                            </tr>
                            <tr>
                                <th>Jumlah Jam Kerja Per Hari</th>
                                <th>:</th>
                                <th id="jumlahJamKerja">
                                    {{ $klien['jml_kerja_per_hari'] }}
                                </th>
                            </tr>
                            <tr>
                                <th>Kapasitas Produksi Per Hari</th>
                                <th>:</th>
                                <th id="kapasitasProduksi">
                                    {{ $klien['kapasitas_produksi_per_hari'] }}
                                </th>
                            </tr>
                            <tr>
                                <th>Jumlah Karyawan Terkait Produk Disertifikasi</th>
                                <th>:</th>
                                <th id="jumlahKaryawan">
                                    {{ $klien['jml_kary_produksi'] }}
                                </th>
                            </tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table id="tablePermohonanPerusahaan" class="table stripted-table">
                        ...
                        @foreach ($permohonanPerusahaan as $item)
                            <tr>
                                <td><input type="checkbox" name="pilihNoProses[]" class="form-control" value="{{ $item->id }}"></td>
                                <td>{{ $item->no_proses }}</td>
                                <td>{{ $item->no_order }}</td>
                                <td>{{ $item->nama_skema_sertifikasi }}</td>
                                <td>{{ $item->nama_tujuan_audit }}</td>

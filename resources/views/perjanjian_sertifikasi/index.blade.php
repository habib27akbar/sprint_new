          ...
          <div class="col-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <a href="{{ route('perjanjian_sertifikasi.create') }}" class="btn btn-primary">Tambah</a>
                <br/><br/>
  ...
  @section('js')
    ...
    $(document).ready(function() {
        var t = $('#dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('perjanjian-sertifikasi.getData') }}",
            columns: [
            {
                data: null,
                name: 'rownum',
            ...
            api.columns().every(function(index) {
                ...
                $.ajax({
                url: "{{ route('perjanjian-sertifikasi.getUniqueValues') }}",

...
@section('title','Modul Pemberitahuan')
@section('css')
  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Modul Pemberitahuan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Modul Pemberitahuan</a></li>
  ...
  @section('js')
    ...
    $(document).ready(function() {
        var t = $('#dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('sertifikat-data.getData') }}",
            columns: [
            {
                data: null,
                name: 'rownum',
            ...
            api.columns().every(function(index) {
                ...
                $.ajax({
                url: "{{ route('sertifikat-data.getUniqueValues') }}",

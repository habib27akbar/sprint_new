                ...
                <form action="{{ route('sertifikat.store') }}" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                            ...
                            <div class="col-sm-4">
                               <select name="menu" onchange="selectMenu(this.value)" class="form-control" required>
                                ...
                                @foreach ($skema as $item)
                                    <option value="{{ $item->id }}">{{ $item->nama_skema_sertifikasi }}</option>
                                @endforeach
                               </select>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                               <input type="text" name="dua_digit" class="form-control">
                            </div>
                            <label for="file" class="col-sm-2 col-form-label">Sub Kelompok</label>
                            <div class="col-sm-4">
                               <input type="text" name="sub_kelompok" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                               <input type="text" name="nace" class="form-control">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                               <input type="text" name="penerapan_sni" class="form-control">
                            </div>
                            <label for="file" class="col-sm-2 col-form-label">Tersertifikasi Sejak</label>
                            <div class="col-sm-4">
                               <input type="date" name="tersertifikasi_sejak" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                               <select name="status_sertifikat" class="form-control" required>
                                    ...
                                    <option value="LEWAT TANGGAL BERAKHIR">LEWAT TANGGAL BERAKHIR</option>
                               </select>
                            </div>

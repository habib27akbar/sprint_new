          ...
          <div class="col-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <a href="{{ route('skema_sertifikasi.create') }}" class="btn btn-primary">Tambah</a>
                <br/><br/>
  ...
  @section('js')
    ...
    $(document).ready(function() {
        var t = $('#dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('skema-sertifikasi.getData') }}",
            columns: [
            {
                data: null,
                name: 'rownum',
            ...
            { data: 'kode_skema_sertifikasi', name: 'kode_skema_sertifikasi' },
            { data: 'nama_skema_sertifikasi', name: 'nama_skema_sertifikasi' },
            { data: 'kode_no_order', name: 'kode_no_order' },
            ...
            api.columns().every(function(index) {
                ...
                $.ajax({
                url: "{{ route('skema-sertifikasi.getUniqueValues') }}",
